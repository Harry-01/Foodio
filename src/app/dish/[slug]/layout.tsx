          ...
          <div className="flex flex-col col-span-2 space-y-6">{children}</div>
            ...
            <div className="hidden md:block overflow-hidden h-fit rounded-lg border border-gray-200 order-first md:order-last">
              <div className="px-6 py-4">
                <p className="font-semibold py-3">About dish/{dish.name}</p>
              </div>
              ...
              <dl className='divide-y divide-gray-100 px-6 py-4 text-sm leading-6 bg-white'>
                <div className='flex justify-between gap-x-4 py-3'>
                    ...
                    <dd className='text-gray-700'>
                        <time dateTime={dish.CreateAt.toDateString()}>
                            {format(dish.CreateAt, 'MMMM d, yyyy')}
                        </time>
                    </dd>
                </div>
                <div className='flex justify-between pag-x-4 py-3'>
                ...
                {dish.creatorId === session?.user.id ? (
                    <div className='flex justify-between gap-x-4 py-3'>
                        <p className='text-gray-500'>You created this dish</p>
                    </div>
                ) : null}
